...
|Resultado esperado|O sistema deve guardar todas as informações disponibilizadas pelo ator e registrá-las em nosso banco de dados compartilhado|
...
Denuncie (encaminha o ator até a página de denúncia),Refazer o teste(Possibilita de forma imediata realizar novamente o teste, regressando a tela de teste inicial, O ator pode regressar à homepage diretamente pelo logo do “Minas Unidas” no canto superior esquerdo|
